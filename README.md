...
本系統是一款專為 2026 年環境監測設計的物聯網（IoT）可視化平台。系統深度整合全台微型感測器數據，提供高頻率、分頁遞迴抓取的 PM2.5 即時監測。

在 **v3.2.7** 版本中，優化導航定位的視覺體驗，並強化「人文引擎」，使其成為兼具技術深度與在地關懷的智慧巡檢工具。
...
* **v3.2.0**: 穩定版，導入人文時鐘與分頁抓取機制。
* **v3.2.7**: 導入科技定位特效，擴充 2026 年完整國定假日與 24 節氣清單。
